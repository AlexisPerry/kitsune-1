...
/// Convert `fir.do_concurrent_loop` to CFG
class CfgConcurrentLoopConv : public mlir::OpRewritePattern<fir::DoConcurrentLoopOp> {
public:
  using OpRewritePattern::OpRewritePattern;
...
public:
  void runOnOperation() override {
    ...
    bool transformAll = transformIterateWhile && transformDoLoop && transformDoConcurrentLoop && transformIf;
    if (transformAll) {
